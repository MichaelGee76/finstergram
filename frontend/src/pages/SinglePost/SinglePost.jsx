        ...
        /> */}
                ...
                <article className="post_wrapper">
                    <div className="post_upper">
                        ...
                        >
                            <img
                                src={postData.post.userId.profilePicture}
                                alt=""
                            />
                            <div>
              ...
              <p>{crementLike}</p>
                    ...
                    <section className="cmnt_section">
                        {postData.commentDetails.length > 0 ? (
                            ...
                            <p>
                                No comments yet. Be the first one to leave a
                                comment!
                            </p>
                        )}
