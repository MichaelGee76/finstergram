...
// Middleware für CORS, Logging und Cookies
const twoWeeksInMs = 14 * 24 * 60 * 60 * 1000;
const isFrontendLocalhost =
    process.env.FRONTEND_URL.startsWith("http://localhost");
const cookieSessionSecret = process.env.COOKIE_SESSION_SECRET;
...
// Weiterleitung aller anderen Anfragen an
app.use((req, res, next) => {
    res.redirect(301, "https://www.mern-stack.de" + req.originalUrl);
});
